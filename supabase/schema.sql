...
-- Clashes get a numeric suffix ("…-2", "…-3"). The app supplies the value on
-- insert; the patient UUID remains the true internal key.
...
-- ---- 4g. Nursing care plan (individualized inpatient care) ------------------
