...
import type { Admission, Allergy, Bed, CarePlanEntry, CarePlanItem, Consultation, Diagnosis, Order, Patient, Prescription, Result, Transfer, TreatmentRecord, Visit, VisitId, Ward } from "@/types/healthcare";
...
export function usePatientDrawerData(
  ...
  useEffect(() => {
    ...
    setData({
      ...
      prescriptions: getPrescriptionsForVisit(visitId),
