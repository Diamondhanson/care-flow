...
import type { Admission, Patient, StaffId, Visit, VisitId } from "@/types/healthcare";
...
/** Disposition decision grid — part of the doctor console. */
        ...
        {DISPOSITIONS.map((d) => {
          ...
          return (
            <Button
              ...
              variant="outline"
              onClick={() => {
                recordDisposition(visitId, d.value, recorderId);
                onMutated();
              }}
