...
import type { ClinicalTerm, Order, OrderId, OrderType, Result, StaffId, VisitId } from "@/types/healthcare";

/**
 * Diagnostic orders & results. Tests are instant-added from the term picker
 * below the list, then refined inline on each row.
 */
export function OrdersPanel({
  ...
  useFormReset(resetKey, () => setOrderDraft(""));
