...
import { CarePlanSummary } from "@/components/live-board/drawer/care-plan-summary";
import {
...
import type { StaffRole, VisitId } from "@/types/healthcare";
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="flex w-full flex-col gap-0 overflow-y-auto p-0 sm:max-w-md">
        <SheetHeader className="border-b border-border">
          <div className="flex items-center gap-2 pr-8">
            ...
            {patient.is_emergency_anonymous ? (
              <StatusBadge tone="treatment" variant="solid">
        ...
        <div className="flex flex-col gap-6 p-4">
          ...
          {admission ? (
            <CarePlanSummary
              carePlanItems={data.carePlanItems}
              carePlanEntries={data.carePlanEntries}
