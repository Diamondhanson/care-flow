...
import type { BillableItem, BillableItemId, Charge, ChargeId, ChargeStatus, VisitId } from "@careflow/shared";
            ...
            <div className="flex flex-col gap-5">
              ...
              {summary.isEmpty ? (
                ...
                <ChargesTable
                  ...
                  onArmSettle={() => setConfirmingSettle(true)}
                  onCancelSettle={() => setConfirmingSettle(false)}
                  t={t}
                />
              )}
            </div>
