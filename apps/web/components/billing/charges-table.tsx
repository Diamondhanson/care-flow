...
import type { Charge, ChargeId, ChargeStatus } from "@careflow/shared";
          ...
          {summary.isFullySettled ? (
            ...
            <div className="mt-1.5 flex flex-col gap-1.5">
              ...
              <div className="flex gap-1.5">
                <Button variant="outline" className="flex-1" onClick={onCancelSettle}>
                  {t("common.cancel")}
                </Button>
                <Button className="flex-1" onClick={onSettle}>
            ...
            <Button className="mt-1.5 w-full" onClick={onArmSettle}>
              <Wallet className="size-4" />
              {t("billing.settle")}
            </Button>
          )}
