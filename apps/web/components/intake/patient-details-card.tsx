...
import { MARITAL_STATUS_LABEL } from "@/components/patient/background-panel";
import { useT } from "@/components/locale-provider";
import type { MaritalStatus, Sex } from "@careflow/shared";
...
export function PatientDetailsCard({
  ...
  ecName: string;
  setEcName: (v: string) => void;
  ecPhone: string;
  setEcPhone: (v: string) => void;
  ecPhoneInvalid: boolean;
}) {
  const { t } = useT();
  return (
    <Card>
